...
from Final_Assignment.quaquel_github_files.dike_model_function import DikeNetwork
...
if __name__ == '__main__':
    a, b = get_model_for_problem_formulation(3)

    with ema_workbench.SequentialEvaluator(a) as evaluator:
        c, d = evaluator.perform_experiments(scenarios=10)
