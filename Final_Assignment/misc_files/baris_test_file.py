...
from Final_Assignment.Final_Assignment_code import quaquel_github_files_kopie as luc_qa
import Final_Assignment.Final_Assignment_code.quaquel_github_files_kopie.problem_formulation as luc_pf
